...
public class Form_SanPham extends javax.swing.JFrame {
    ...
    public void fillData(int i) {
        ...
        if (sp.getAnh().equalsIgnoreCase("No avata")) {
            ...
            try {
                Image avartarImg = ImageIO.read(new File("E:\\Nhom4\\DuAn1Nhom4\\DuAn1\\src\\imgOto\\" + sp.getAnh()));
    ...
    private void lblImageMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblImageMouseClicked
        try {
            JFileChooser j = new JFileChooser("E:\\Nhom4\\DuAn1Nhom4\\DuAn1\\src\\imgOto\\");
