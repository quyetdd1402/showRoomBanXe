...
public class ViewNhanVien extends javax.swing.JFrame {
    ...
    public void fillData(int i) {
        ...
        if (nv.getAnh().equalsIgnoreCase("No avata")) {
            ...
            lblImage.setText("");
            try {
                Image avartarImg = ImageIO.read(new File("E:\\DuAn1\\DuAn1\\src\\image\\" + nv.getAnh()));
...
//        }
    ...
    private void initComponents() {
        ...
        rdoNam.setBackground(new java.awt.Color(0, 255, 204));
        ...
        rdoNu.setBackground(new java.awt.Color(0, 255, 204));
    ...
    private void btnBrowseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBrowseActionPerformed
        try {
            JFileChooser j = new JFileChooser("E:\\DuAn1\\DuAn1\\src\\image\\");
